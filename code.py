...
observed = pd.concat([return_rating.transpose(),risk_rating.transpose()], 
...
data.drop(['morningstar_rating','portfolio_stocks','category_12','sharpe_ratio_3y'], inplace=True, axis=1)
# code ends here
